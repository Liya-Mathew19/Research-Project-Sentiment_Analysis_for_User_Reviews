...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
			...
			<?php 
$sql=mysqli_query($con,"SELECT * FROM tbl_feedback where f_status='2' and r_id='$b'");
...
<div class="wrap-contact100">
			<span class="contact100-form-symbol">
				<center><img src="images/icons/symbol-01.png" alt="SYMBOL-MAIL"></center>
			</span>

			<form 
			action="resort_system_feedback_action.php" method="post" enctype="multipart/form-data" onsubmit="return Validate()" style="margin-top: 20px;">
				<span class="contact100-form-title">
					<center>Feedback</center>
				</span>
				<div class="wrap-input100 validate-input">
					<center><textarea class="input100" name="message" placeholder="Write  Your Feedback Here!!!"></textarea></center>	
...
<center><button class="button button3" type="submit" name="submit">Save</button></center>
</form>
</div>
...
{
	echo "<hr><hr><hr><br><br><center><font color=green size=3>Feedback Already entered !!!</font></center></div>";
}
