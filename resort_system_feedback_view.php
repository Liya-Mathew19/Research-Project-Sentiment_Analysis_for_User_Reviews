...
<?php
include 'dbconnect.php';
$res1=mysqli_query($con,"SELECT * FROM `tbl_feedback` where f_status=2  and `r_id`='$kid'");
...
<?php
	...
	$res=mysqli_query($con,"SELECT * FROM `tbl_feedback` WHERE `r_id`='$a' and `f_status`='2'");
	$i=1;
...
<td><center><a href="resort_system_feedback_delete.php?uid=<?php echo $row['f_id'];?>"><img src="images/DeleteRed.png" width="30px"></a></td></tr>
