...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<form action="booking_action.php" method="post" class="form-horizontal">
	<script>
			<!--//function calc(){ -->
...
<body>
 ...
 <div class="row form-group">
														   ...
														   <div class="row form-group">
															...
															<div><input type="hidden" name="val" value="<?php $row1=$_GET['uid']; echo $row1;?>"/></div>
															<div><input type="hidden" name="val1" value="<?php $hid=$_GET['uid1']; echo $hid;?>"/></div>
